...
<table class="admin_write" >
			...
			<tr>
				<td> 아이디 </td>
				<td> <input type="text" id="buserId" name="buserId" size = "50" value="${admin.buserId }"></td>
			</tr>
			...
			<tr>
				<td> 성명 </td>
				<td> <input type="text" id="bName" name="bName" size = "50"value="${admin.bName }"></td>
			</tr>
			
			<tr>
				<td> 부서 </td>
				<td> <input type="text" id="bDepartment" name="bDepartment" size = "50"value="${admin.bDepartment }"></td>
			</tr>
			
			<tr>
				<td> 이메일 </td>
				<td> <input type="text" id="bEmail" name="bEmail" size = "50"value="${admin.bEmail }"></td>
			</tr>
			
			<tr>
				<td> 휴대폰 </td>
				<td> <input type="text" id="bTnumber" name="bTnumber" size = "50"value="${admin.bTnumber }"></td>
				<th> 사내 전화번호</th>
				<th> <input type="text" id=bTbusniess name="bTbusniess" size = "50"value="${admin.bTbusniess }"></th>
			</tr>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function fn_openAdminList(){
		        ...
		        comSubmit.setUrl("<c:url value='/openAdminlist' />");
		        comSubmit.submit();
		    }
			
			function fn_openAdmindelete(){
				var bId = "${admin.bId }"
		        var comSubmit = new ComSubmit();//자바스크립트 객체 생성(common.js에 submit기능 함수 만듦)
		        comSubmit.setUrl("<c:url value='/openAdmindelete' />");
		        comSubmit.addParam("bId", bId);
		        comSubmit.submit();
		    }
			
			function fn_openAdminmodify(){
				var bId = "${admin.bId }"
		        var comSubmit = new ComSubmit("admininsert");//자바스크립트 객체 생성(common.js에 submit기능 함수 만듦)
		        comSubmit.setUrl("<c:url value='/openAdminmodify' />");
		        comSubmit.addParam("bId", bId);
		        comSubmit.submit();
		    }
