	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function fn_openetronoticeList(){
		        ...
		        comSubmit.setUrl("<c:url value='/Admin/openEtronoticelist' />");
		        comSubmit.submit();
		    }
			...
			function fn_openetronoticedelete(){
		        ...
		        var comSubmit = new ComSubmit();//자바스크립트 객체 생성(common.js에 submit기능 함수 만듦)
		        comSubmit.setUrl("<c:url value='/Admin/openEtronoticedelete' />");
			...
			function fn_openetronoticemodify(){
		        ...
		        comSubmit.setUrl("<c:url value='/Admin/openEtronoticemodify' />");
		        comSubmit.addParam("bId", bId);
		        comSubmit.submit();
		    }
