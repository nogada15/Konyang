...
<table class="hire_write" >
			...
			<tr>
				...
				<td><input type="text" value="${hire.applycareer}" name="applycareer" id = "career"></td>
				
			</tr>
			<tr>
				<td>신입</td>
				
				<td><input type="text" value="${hire.applynewcomer}" name="applynewcomer" id="newcomer"></td>
			</tr>
			<tr>
				<td>인턴</td>
			
				<td><input type="text" value="${hire.applyintern}" name="applyintern" id="intern"></td>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function fn_openHiredelete(){
				var bId = "${hire.bId }"
		        var comSubmit = new ComSubmit();//자바스크립트 객체 생성(common.js에 submit기능 함수 만듦)
		        comSubmit.setUrl("<c:url value='/Admin/openhiredelete' />");
			...
			function fn_openHiremodify(){
		        ...
		        comSubmit.setUrl("<c:url value='/Admin/openhiremodify' />");
		        comSubmit.addParam("bId", bId);
		        comSubmit.submit();
		    }
