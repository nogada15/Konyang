		...
		$(document).ready(function() {
			$("#insert").on("click", function(e){
		 	...
		 	function fn_chageLangSelect(){
		        ...
		        comSubmit.setUrl("<c:url value='/openbenerview' />");
			...
			function fn_openbenerInsert(){
		        ...
		        comSubmit.setUrl("<c:url value='/openinsertbener' />");
		        comSubmit.submit();
		    }
			
			function fn_openbenerDelete1() {
				var comSubmit = new ComSubmit("insertbener");
				comSubmit.setUrl("<c:url value='/openbenerdelete1' />");
				comSubmit.submit();
			}
			   function fn_openbenerDelete2() {
				var comSubmit = new ComSubmit("insertbener");
				comSubmit.setUrl("<c:url value='/openbenerdelete2' />");
				comSubmit.submit();
			}
			function fn_openbenerDelete3() {
				var comSubmit = new ComSubmit("insertbener");
				comSubmit.setUrl("<c:url value='/openbenerdelete3' />");
				comSubmit.submit();
			}
			function fn_openbenerDelete4() {
				var comSubmit = new ComSubmit("insertbener");
				comSubmit.setUrl("<c:url value='/openbenerdelete4' />");
				comSubmit.submit();
			}
			function fn_openbenerDelete5() {
				var comSubmit = new ComSubmit("insertbener");
				comSubmit.setUrl("<c:url value='/openbenerdelete5' />");
				comSubmit.submit();
			}
			function fn_openbenerDelete6() {
				var comSubmit = new ComSubmit("insertbener");
				comSubmit.setUrl("<c:url value='/openbenerdelete6' />");
				comSubmit.submit();
			}   
