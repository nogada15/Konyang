...
<form id="Managerinsert" method="post">
	<table class="manager_write">
			...
			<tr>
				<td> 전화번호 </td>
				<td> <input type="text" name="bTnumber" size = "50"> </td>
			</tr>
