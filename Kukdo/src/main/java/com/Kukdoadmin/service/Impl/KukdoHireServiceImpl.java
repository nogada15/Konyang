...
import com.Kukdoadmin.DAO.HireDAO;
...
@Service
public class KukdoHireServiceImpl implements KukdoHireService {
	...
	public ArrayList<FaqModel> getAllFaq() {
		return (ArrayList<FaqModel>) dao.getAllFaq();
	}*/
