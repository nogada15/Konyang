...
public class HireDAO {
	...
	public void insertApplycareer(ApplyModel apmd) {
		
		template.insert("apply.insertApplycareer", apmd);
	}
	
	@SuppressWarnings("unchecked")
	public ArrayList<ApplyCareer> getAllApplycareer(){
		
		return (ArrayList<ApplyCareer>) template.queryForList("apply.getAllApplycareer");
	}
	
	public void insertApplynewcomer(ApplyModel apmd) {
		
		template.insert("apply.insertApplynewcomer", apmd);
	}
	
	@SuppressWarnings("unchecked")
	public ArrayList<ApplyNewComer> getAllApplynewcomer(){
		
		return (ArrayList<ApplyNewComer>) template.queryForList("apply.getAllApplynewcomer");
	}
	
	public void insertApplyintern(ApplyModel apmd) {
		
		template.insert("apply.insertApplyintern", apmd);
	}
	
	@SuppressWarnings("unchecked")
	public ArrayList<ApplyIntern> getAllApplyintern(){
		
		return (ArrayList<ApplyIntern>) template.queryForList("apply.getAllApplyintern");
	}
	
	@SuppressWarnings("unchecked")
	public ArrayList<ApplyModel> getAllApplyall(){
		
		return (ArrayList<ApplyModel>) template.queryForList("apply.getAllApplyall");
	}
	
	public void insertEmploy(EmployModel empmd) {
		
		template.insert("employ.insertEmploy", empmd);
	}
	
	@SuppressWarnings("unchecked")
	public ArrayList<EmployModel> getAllEmploy(){
		return (ArrayList<EmployModel>) template.queryForList("employ.getAllEmploys");
	}
	
	/*public void insertFaq(FaqModel faqmd) {
		template.insert("faq.insertFaq", faqmd);
	}*/
	
	/*@SuppressWarnings("unchecked")
	public ArrayList<FaqModel> getAllFaq(){
		return (ArrayList<FaqModel>) template.queryForList("faq.getAllFaqs");
	}*/
}
