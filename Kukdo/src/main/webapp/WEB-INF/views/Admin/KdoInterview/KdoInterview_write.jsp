...
<table class="Kdointerview_write" >
			...
			<tr>
				<td> 간략정보 </td>
				<td> <textarea name="bSimpContent" id="bSimpContent" rows="5" cols="100"></textarea> </td>
			</tr>
