...
<script type="text/javascript">
	function sendcareer(career,newcomer,intern)
	{
		
		opener.document.getElementById("career").value=career
		opener.document.getElementById("newcomer").value=newcomer
		opener.document.getElementById("intern").value=intern
	...
	<form action="select" method="post">
		<input type="button" value="선택반영" onClick="sendcareer(career.value,newcomer.value,intern.value); return false;">
